...
import { InstructIcon } from "../../shared/utils/icons/Icons";
import "../../shared/styles/table_antd_custom.css";

export const TableCanceledDetailPage = () => {
  const deskColumns = [
  ...
  return (
    <>
      <div className="w-full h-full flex flex-col p-6 bg-transparent">
        <div>
          <Link to="/user/table-canceled" className="text-sm">Bàn đã hủy</Link>
          <span>&nbsp;/&nbsp;</span>
              ...
              <div className="flex-1 mt-4! pe-4">
                  <div className="flex gap-x-10">
                      ...
                      <div className="flex flex-col text-base gap-y-1">
                          ...
                          <div className="flex">
                              ...
                              <span>
                                  <span>:&nbsp;</span>
                                  <span className="text-red-500">Đã hủy</span><span>&nbsp;</span>
                  ...
                  <div className="flex mt-2 px-2">
                      <div className="flex-1 flex gap-2">
                          <span className="text-base text-gray-400">Mã giảm giá:</span>
                      </div>
